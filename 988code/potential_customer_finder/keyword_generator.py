...
"""
        ...
        prompt = f"""你是一個專門分析客戶購買行為的專家。我需要你為產品「{product_name}」生成客戶在搜尋時可能使用的**所有可能表達方式**。
...
**菌類產品**：
- 杏鮑菇 → 刺芹側耳、杏鲍菇（簡體）、杏苞菇、杏包菇等
- 香菇 → 花菇、冬菇、椎茸、香菇（簡體：香菇）等

**蔬菜產品**：
- 高麗菜 → 包心菜、甘藍菜、椰菜、卷心菜（簡體）等
