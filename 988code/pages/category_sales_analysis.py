...
tab_content = html.Div([
    ...
    html.Div([
        ...
        ], id="item-popover-form", target="item-add-button", placement="bottom-start", trigger="click", style={"width": "350px", "backgroundColor": "#f8f9fa", "border": "1px solid #dee2e6", "boxShadow": "0 4px 8px rgba(0,0,0,0.1)", "padding": "15px"}, hide_arrow=True),
